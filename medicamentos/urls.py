...
urlpatterns = [
    ...
    # ── Prescripciones ──────────────────────────────────────
     path('residentes/<int:pk>/medicamentos/',
          PrescripcionListCreateView.as_view(),
          name='prescripcion-list-create'),

     path('residentes/<int:pk>/medicamentos/<int:pm_id>/',
          PrescripcionDetailView.as_view(),
          name='prescripcion-detail'),

     path('residentes/<int:pk>/medicamentos/<int:pm_id>/finalizar/',
     ...
     path('administraciones/<int:adm_id>/',
          AdministracionDetailView.as_view(),
          name='administracion-detail'),

     path('residentes/<int:pk>/administraciones/',
