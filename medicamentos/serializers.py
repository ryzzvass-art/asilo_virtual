...
class ResidenteMedicamentoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'residente', 'medicamento', 'medicamento_nombre',
            'prescrito_por', 'prescrito_por_nombre',
            'dosis', 'via_administracion', 'horarios',
            'fecha_inicio', 'fecha_fin', 'estado', 'created_at',
        ]
        read_only_fields = [
             'residente','prescrito_por', 'prescrito_por_nombre',
            'medicamento_nombre', 'estado', 'created_at',
        ]
...
class AdministracionMedicamentoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'residente_medicamento',
            'realizado_por', 'realizado_por_nombre', 'residente_nombre',
            'administrado', 'fecha_hora_programada', 'fecha_hora_real',
            'observacion',
        ]
    ...
    def validate(self, data):
        ...
        if not data.get('administrado', True) and not data.get('observacion', '').strip():
            raise serializers.ValidationError({
