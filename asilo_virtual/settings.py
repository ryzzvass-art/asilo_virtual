...
# ==================== ALLOWED_HOSTS ====================
ALLOWED_HOSTS = [
    'asilo-virtual.onrender.com',
    'asilo-virtual.onrender.com.', # a veces Render usa punto final
    '.onrender.com', # más flexible
    'localhost',
    '127.0.0.1',
]
...
# ==================== BASE DE DATOS ====================
if os.environ.get('DATABASE_URL'):
    # Producción — Render (MEJORADO)
    DATABASES = {
        'default': dj_database_url.config(
            default=os.environ.get('DATABASE_URL'),
            conn_max_age=600,
            conn_health_checks=True, # ← Muy importante
            ssl_require=True, # Render lo exige
        )
    }
else:
    # Desarrollo local
